...
- [AUTH-3.1](./AUTH-3.1-define-user-preferences-schema) - Define Drizzle Schema for user_preferences
- [AUTH-3.2](./AUTH-3.2-generate-apply-migration) - Generate and Apply user_preferences Migration
- [AUTH-3.3](./AUTH-3.3-create-fetch-profile-endpoint) - Create API Endpoint to Fetch User Profile (GET /api/users/me)
- [AUTH-3.4](./AUTH-3.4-define-profile-update-schema) - Define Zod Schema for Profile Updates
- [AUTH-3.5](./AUTH-3.5-create-update-profile-endpoint) - Create API Endpoint to Update User Profile (PATCH /api/users/me)
