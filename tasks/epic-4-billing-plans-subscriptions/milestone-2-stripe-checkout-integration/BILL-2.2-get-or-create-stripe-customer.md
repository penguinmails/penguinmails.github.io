...
description: "Documentation for BILL-2.2: Implement \\"Get or Create Stripe Customer\\" Logic - BILL 2.2 Get Or Create Stripe Customer"
...
- **BILL-1.2** - Tenant_config table must exist in database
