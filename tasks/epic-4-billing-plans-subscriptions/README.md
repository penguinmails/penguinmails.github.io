...
- **Business Model:** From [Goals & Competitive Edge](../docs/goals-competitive-edge/index.md), PenguinMails uses a B2B SaaS subscription model with multi-tier pricing
...
- **Subscription Tiers:** From [Implementation & Getting Started](../docs/implementation-getting-started/index.md), the platform offers Starter ($99/month), Professional ($299/month), and Enterprise (custom pricing) plans
- **Stripe Connect:** The [Implementation & Getting Started](../docs/implementation-getting-started/index.md) document outlines the Stripe Connect integration for B2B billing
