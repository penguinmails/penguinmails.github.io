...
- [CORE-1.2](/docs/features/core/tasks/CORE-1.2-configure-eslint) - ESLint must be configured
- [CORE-1.3](/docs/features/core/tasks/CORE-1.3-configure-prettier) - Prettier must be configured
