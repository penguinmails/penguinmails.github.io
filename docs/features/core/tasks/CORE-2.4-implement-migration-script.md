...
- [Production Deployment](/docs/operations/production-deployment) - Deployment workflows

## Dependencies

- [CORE-2.1](/docs/features/core/tasks/CORE-2.1-install-configure-drizzle) - Drizzle ORM must be configured
- [CORE-2.3](/docs/features/core/tasks/CORE-2.3-generate-first-migration) - Migration file must be generated
