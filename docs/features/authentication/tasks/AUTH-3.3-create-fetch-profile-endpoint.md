---
title: "AUTH-3.3: Create API Endpoint to Fetch User Profile (GET /api/users/me)"
description: ""
...
- [CORE-3.5](/docs/features/authentication/tasks/CORE-3.5-create-protected-endpoint) - Basic user context endpoint exists (from Epic 1)
...
- [AUTH-3.2](/docs/features/authentication/tasks/AUTH-3.2-generate-apply-migration) - User preferences table must exist in database
