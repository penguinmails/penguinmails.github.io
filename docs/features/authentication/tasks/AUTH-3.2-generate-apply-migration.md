...
- [CORE-2.3](/docs/features/core/tasks/CORE-2.3-generate-first-migration) - Migration generation script must be working (from Epic 1)
- [CORE-2.4](/docs/features/core/tasks/CORE-2.4-implement-migration-script) - Migration application script must be working (from Epic 1)
