...
- [AUTH-3.3](/docs/features/authentication/tasks/AUTH-3.3-create-fetch-profile-endpoint) - GET /api/users/me endpoint exists (for reference)
- [AUTH-3.4](/docs/features/authentication/tasks/AUTH-3.4-define-profile-update-schema) - Update profile schema must be defined
