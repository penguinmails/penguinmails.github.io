...
- [CORE-3.2](/docs/features/authentication/tasks/CORE-3.2-implement-middleware) - Middleware must allow public access to this route
- [CORE-5.1](/docs/features/core/tasks/CORE-5.1-install-zod-define-schemas) - Zod signup schema must be defined
