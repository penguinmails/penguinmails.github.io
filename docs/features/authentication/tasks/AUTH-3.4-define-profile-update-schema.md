...
- [CORE-5.1](/docs/features/core/tasks/CORE-5.1-install-zod-define-schemas) - Zod must be installed (from Epic 1)
- [AUTH-3.1](/docs/features/authentication/tasks/AUTH-3.1-define-user-preferences-schema) - User preferences schema must be defined (to know what fields to validate)
