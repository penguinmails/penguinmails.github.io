...
- [INFRA-1.4](/docs/features/infrastructure/tasks/INFRA-1.4-create-a-secure-hostwind-api-client-service) - Hostwind API client service must be created
- [INFRA-1.3](/docs/features/infrastructure/tasks/INFRA-1.3-configure-hostwind-api-credentials) - API credentials must be configured
