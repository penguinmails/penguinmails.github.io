...
- [INFRA-2.3](/docs/features/infrastructure/tasks/INFRA-2.3-create-a-scheduled-cron-job-for-synchronization) - Cron job must be implemented
...
- [Development Standards (system config & monitoring)](/docs/implementation-technical/development-guidelines/development-standards)
