...
- [INFRA-1.3](/docs/features/infrastructure/tasks/INFRA-1.3-configure-hostwind-api-credentials) - Hostwind API credentials must be configured
- [CORE-1.1](/docs/features/core/tasks/CORE-1.1-initialize-nextjs-project) - Next.js project must be initialized (for TypeScript support)
