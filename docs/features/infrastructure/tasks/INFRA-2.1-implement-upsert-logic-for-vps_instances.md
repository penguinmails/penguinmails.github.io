...
- [INFRA-1.1](/docs/features/infrastructure/tasks/INFRA-1.1-define-drizzle-schemas-for-infrastructure) - VPS instances schema must be defined
...
- [INFRA-1.5](/docs/features/infrastructure/tasks/INFRA-1.5-implement-getvpsinstances-function) - getVpsInstances() function must be implemented
