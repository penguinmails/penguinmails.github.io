...
- [BILL-1.1](/docs/features/payments/tasks/BILL-1.1-define-billing-schemas) - Subscriptions schema must be defined
- [BILL-1.2](/docs/features/payments/tasks/BILL-1.2-generate-apply-billing-migrations) - Subscriptions table must exist in database
