...
- [BILL-3.1](/docs/features/payments/tasks/BILL-3.1-create-webhook-handler) - Webhook handler must be implemented
- [BILL-3.2](/docs/features/payments/tasks/BILL-3.2-handle-checkout-completed) - Checkout completed handler should exist (for context)
- [BILL-1.1](/docs/features/payments/tasks/BILL-1.1-define-billing-schemas) - Subscriptions and plans schemas must be defined
