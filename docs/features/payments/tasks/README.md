...
- [BILL-1.1](/docs/features/payments/tasks/BILL-1.1-define-billing-schemas) - Define Drizzle Schemas for Billing
- [BILL-1.2](/docs/features/payments/tasks/BILL-1.2-generate-apply-billing-migrations) - Generate and Apply Billing Migrations
- [BILL-1.3](/docs/features/payments/tasks/BILL-1.3-seed-plans-table) - Seed the plans Table
- [BILL-1.4](/docs/features/payments/tasks/BILL-1.4-list-plans-endpoint) - Create API Endpoint to List Plans (GET /api/plans)
