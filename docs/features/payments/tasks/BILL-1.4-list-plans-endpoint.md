...
- [BILL-1.1](/docs/features/payments/tasks/BILL-1.1-define-billing-schemas) - Plans schema must be defined
- [BILL-1.2](/docs/features/payments/tasks/BILL-1.2-generate-apply-billing-migrations) - Plans table must exist in database
- [BILL-1.3](/docs/features/payments/tasks/BILL-1.3-seed-plans-table) - Plans should be seeded (for testing)
