...
- [TEN-2.2](/docs/features/teams/tasks/TEN-2.2-get-company-details-endpoint) - GET company endpoint exists (for reference)
- [TEN-2.3](/docs/features/teams/tasks/TEN-2.3-define-company-update-schema) - Update company schema must be defined
