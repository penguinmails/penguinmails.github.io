...
- [TEN-1.1](/docs/features/teams/tasks/TEN-1.1-define-companies-schema) - Define Drizzle Schema for companies
- [TEN-1.2](/docs/features/teams/tasks/TEN-1.2-generate-apply-migration) - Generate and Apply companies Migration
- [TEN-1.3](/docs/features/teams/tasks/TEN-1.3-define-tenant-creation-schema) - Define Zod Schema for Tenant & Company Creation
- [TEN-1.4](/docs/features/teams/tasks/TEN-1.4-create-tenant-company-endpoint) - Create API Endpoint for Tenant & Company Creation (POST /api/tenants)
