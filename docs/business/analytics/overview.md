...
├── Analytics: 320 users (↑18% adoption)
...
├── Product Health Score: 8.2/10
└── Innovation Pipeline: 8 ideas in progress

Feature Performance
├── Top Performers: Analytics (85% adoption, 4.6 satisfaction)
├── Needs Improvement: API Integration (12% error rate)
├── Growing Fast: Templates (+25% adoption MoM)
...
- **[Business Strategy Overview](../strategy/overview.md)** - Strategic context and objectives
- **[Market Analysis](../market-analysis/overview.md)** - Market intelligence and positioning
...
---
*Next: [Business Operations Overview](../operations/overview.md) →*