...
- [Market Analysis Overview](/docs/business/market-analysis/overview) - Market positioning for financial analysis
- [Competitive Analysis Overview](/docs/business/core/competitive-analysis) - Competitive landscape and cost positioning

### Operations & Analytics

- [Operations Management Overview](/docs/business/operations/strategy/framework) - Operational cost management and analytics
- [Payment Analytics & Financial Operations](/docs/business/operations/strategy/framework) - Financial operations and billing management
- [Infrastructure Operations Management](/docs/business/operations/strategy/framework) - Database and infrastructure operational procedures

### Technical Architecture

- [Architecture Overview](/docs/technical/architecture/overview) - System architecture for financial planning
