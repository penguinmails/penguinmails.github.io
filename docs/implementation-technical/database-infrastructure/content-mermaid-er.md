...
- Generic logging/telemetry/infra metrics (see [`external-analytics-logging`](docs/implementation-technical/database-infrastructure/external-analytics-logging:1))
