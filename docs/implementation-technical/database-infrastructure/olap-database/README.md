...
- **[Schema Guide](schema-guide.md)** - Complete analytics warehouse schema and design principles
...
|----------|---------|----------------|
| [Schema Guide](schema-guide.md) | Complete OLAP schema and implementation | Data engineers |
